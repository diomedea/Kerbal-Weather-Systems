...
namespace Database
{
    ...
    public struct CloudData
    {
        ...
        [ProtoMember(3)]
        public float dropletSize; //TODO change desc: stored as Int16, values -32768 to +32767. Divided by 1E7 to have values in tenths of microns (up to 3276.7 µm, or 3.2767 mm). Sign used to store the IsIce bool (- = true). 
        [ProtoMember(4)]
